...
export const PROTECTED_ROUTES = ["/dashboard", "/settings", "/billing", "/brand/onboarding", "/brand/signup-complete", "/brand/signup-confirmation", "/brand/demo-dashboard"] as const;
